...
lazy_static! {
	pub static ref FIRST_LETTER_POSITION: FirstLetterPosition = {
		...
		data.insert('H', (173, 185));
		data.insert('q', (1577, 1587));
		data.insert('D', (65, 119));
		data.insert('Q', (387, 391));
		data.insert('f', (967, 1002));
		data.insert('U', (496, 532));
		data.insert('e', (905, 967));
		data.insert('x', (1983, 2007));
		data.insert('i', (1086, 1136));
		data.insert('s', (1689, 1837));
		data.insert('d', (841, 905));
		data.insert('k', (1144, 1154));
		data.insert('J', (210, 217));
		data.insert('Z', (568, 578));
		data.insert('T', (475, 496));
		data.insert('C', (31, 65));
		data.insert('g', (1002, 1058));
		data.insert('X', (554, 558));
		data.insert('P', (368, 387));
		data.insert('m', (1302, 1339));
		data.insert('O', (345, 368));
		data.insert('y', (2007, 2018));
		data.insert('Y', (558, 568));
		data.insert('W', (549, 554));
		data.insert('l', (1154, 1302));
		data.insert('V', (532, 549));
		data.insert('z', (2018, 2031));
		data.insert('B', (19, 31));
		data.insert('n', (1339, 1458));
		data.insert('o', (1458, 1511));
		data.insert('j', (1136, 1144));
		data.insert('S', (435, 475));
		data.insert('N', (293, 345));
		data.insert('A', (0, 19));
		data.insert('F', (144, 152));
		data.insert('K', (217, 225));
		data.insert('L', (225, 284));
		data.insert('p', (1511, 1577));
		data.insert('r', (1587, 1689));
		data.insert('G', (152, 173));
		data.insert('R', (391, 435));
		data.insert('h', (1058, 1086));
		data.insert('c', (749, 841));
		data.insert('v', (1940, 1972));
		data.insert('b', (637, 749));
		data.insert('a', (578, 637));
		data.insert('I', (185, 210));
		data.insert('u', (1893, 1940));
		data.insert('t', (1837, 1893));
		data.insert('M', (284, 293));
		data.insert('E', (119, 144));
		data.insert('w', (1972, 1983));
		data
	};
}
